					...
					String c = JOptionPane.showInputDialog(
					 ...
					 if (c.equals("yes")) {
							...
							String v = JOptionPane.showInputDialog(
									"you and your friend both give a fight, but you seem to be losing, until you give up to the spider, and as you are about to get killed, your friend trips over a rock and lands on your sword, do you say push the ruby or not?");
						
							if(v.equals("yes")){
								String b = JOptionPane.showInputDialog("after a blinding flash, your eyes see a dead spider and a shocked friend, then everything goes dark, do you try to open(yes) them or do you try and get to your friend(no)");
							}
...
if(x.equals("no")){JOptionPane.showInputDialog("your friend still explores, and finds 1 trillion dollars worth of daimonds");}
